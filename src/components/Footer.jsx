...
const Footer = () => {
  return (
    <footer id="footer" className="relative bg-slate-950 text-gray-300 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `
              ...
              radial-gradient(circle at 75% 75%, rgba(249,115,22,0.05) 1px, transparent 1px)
            `,
...
/>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500">Drop us a message</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <nav className="grid grid-cols-2 gap-2">
                {['About', '  Services', 'HowItWorks'].map((item) => (
                  <a key={item} href="#" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">
                    {item}
                  </a>
                ))}
              </nav>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-slate-800/60 pt-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-3">
            {[Linkedin, Youtube, Instagram, Twitter].map((Icon, index) => (
              <a
                key={index}
                href="#"
                className="w-9 h-9 bg-slate-900/40 rounded-lg flex items-center justify-center text-gray-400 hover:text-orange-400 hover:bg-slate-800/60 transition-all duration-200"
              >
