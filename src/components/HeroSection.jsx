...
const HeroSection = () => {
  const stats = [
    ...
    { icon: <TrendingUp className="w-5 h-5" />, value: "5K+", label: "Projects Complete" },
    ...
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto text-white">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          Discover opportunities. <span className="text-blue-400 font-medium">Post projects.</span>{" "}
          <span className="text-purple-400 font-medium">Bid competitively.</span>
        </p>

        {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <button className="group relative px-6 py-3 bg-transparent rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-105">
